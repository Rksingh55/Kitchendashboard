            ...
            <div className='mainbanner '><br /><br /><br />
                <div className=' border-t-[3px]'>
                    <div className='flex  md:flex-row flex-col '>
                        <div className='basis-[30%] max-sm:hidden bg-red-200  login1'></div>
                        <div className='md:basis-[70%]  h-[92vh] flex justify-center items-center  '>
                            <div className='border-[1px] shadow-md border-white md:w-[60%] w-[100%]  wrapper rounded-md max-sm:m-3'>
                                <div
                                    class="relative flex md:w-[80%] w-[100%]  mt-10 m-auto flex-col       bg-clip-border text-gray-700  md:pb-[100px]"
                                >
                                    <div
                                        class="relative mx-4  mb-4 grid h-28 place-items-center overflow-hidden  bg-gradient-to-tr from-cyan-600 to-cyan-400 bg-clip-border text-white shadow-lg "
                                    >
                                        <h3
                                    ...
                                    <div class="flex flex-col gap-4 p-6">
                                        <div class="relative h-11 w-full min-w-[200px]">
                                            <input
                                                placeholder=""
                                                class="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-white outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-cyan-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 placeholder:text-white"
                                            />
                                            <label
                                        ...
                                        <div class="relative h-11 w-full min-w-[200px]">
                                            ...
                                            />
                                            <label
                                                class="before:content[' '] placeholder:text-white after:content[' '] pointer-events-none absolute left-0 -top-1.5 flex h-full w-full select-none text-[11px] font-normal leading-tight text-blue-gray-400 transition-all before:pointer-events-none before:mt-[6.5px] before:mr-1 before:box-border before:block before:h-1.5 before:w-2.5 before:rounded-tl-md before:border-t before:border-l before:border-blue-gray-200 before:transition-all after:pointer-events-none after:mt-[6.5px] after:ml-1 after:box-border after:block after:h-1.5 after:w-2.5 after:flex-grow after:rounded-tr-md after:border-t after:border-r after:border-blue-gray-200 after:transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:leading-[4.1] peer-placeholder-shown:text-blue-gray-500 peer-placeholder-shown:before:border-transparent peer-placeholder-shown:after:border-transparent peer-focus:text-[11px] peer-focus:leading-tight peer-focus:text-cyan-500 peer-focus:before:border-t-2 peer-focus:before:border-l-2 peer-focus:before:!border-cyan-500 peer-focus:after:border-t-2 peer-focus:after:border-r-2 peer-focus:after:!border-cyan-500 peer-disabled:text-transparent peer-disabled:before:border-transparent peer-disabled:after:border-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500"
                                            >
                                                Password
                                            </label>
                                        </div>
                                        <div class="-ml-2.5">
                                            <div class="inline-flex items-center">
                                                ...
                                                <label
                                                    for="checkbox"
                                                    class="mt-px cursor-pointer select-none  text-white font-bold"
                                                >
                                                    Remember Me
                                                </label>
                                            </div>
                                    ...
                                    <div class="p-6 pt-0">
                                       ...
                                       <button
                                        ...
                                        <p
                                            class="mt-6 flex justify-center font-sans text-sm text-white  leading-normal text-inherit antialiased"
                                        >
